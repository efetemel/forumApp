...
SECRET_KEY = 'go*-@_71qu7_%q*r_0h@p+9jik%ihsih!4-a)&1j!o#lt(a=)%'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['forumsozluk.dynet.com']
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'ersozyazilim@gmail.com'
EMAIL_HOST_PASSWORD = 'Efe123tamer2004'
